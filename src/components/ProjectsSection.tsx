...
const projects = [
  ...
  },
  {
    ...
    description: "A multi-encoder system that generates natural-language descriptions from raw audio. PyTorch Lightning pipeline combines 3 encoders: BEATs, ConvNeXt, AST, with configurable fusions, a Conformer post-encoder, and BART decoding. Re-ranking stage samples multiple candidate captions using Nucleus Sampling, ranks them using CLAP-based audio-text similarity, and refines the strongest outputs with GPT. Evaluated with FENSE and standard DCASE metrics. Achieves comparable performance to SOTA with 94% fewer parameters.",
  ...
  },
  {
    ...
    paperLink: `${BASE_URL}Learning%20the%20Groove_%20Fine-Tuning%20Beat%20Tracking%20on%20the%20Jazz%20Trio%20Dataset.pdf`,
    paperLinkLabel: "Read paper",
    imageFit: "cover" as const,
  },
  {
  ...
  },
  {
    ...
    description: "A clean, lightweight Chrome extension that records and saves your browser's audio in real time. It lets users capture any sound from the browser for quick sampling, with an intuitive UI and multiple export options for seamless integration into creative or production workflows. Over 100+ active users.",
